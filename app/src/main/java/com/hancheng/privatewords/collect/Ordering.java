...
import com.hancheng.privatewords.util.Preconditions;
...
import static com.hancheng.privatewords.collect.CollectPreconditions.checkNonnegative;
 ...
 * <li>{@link #onResultOf(net.tribe7.common.base.Function)}
...
public abstract class Ordering<T> implements Comparator<T> {
    ...
    /**
     * Exception thrown by a {@link Ordering#explicit(java.util.List)} or {@link
